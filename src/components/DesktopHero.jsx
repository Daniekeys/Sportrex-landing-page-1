...
const imagesArray = [
  desk2, 
  desk1 , desk3,desk4,desk5,desk6,desk7, desk8,desk9,desk10,desk11,desk12
...
const styles = {
  ...
  story: "text-white text-2xl",
  btnContainer: "flex space-x-4",
  preBtn: "text-yellow border-yellow border-[1px] px-6 py-2  ",
          ...
          <div className={styles.sectionContainer}>
            ...
            <div className={styles.sectionB}>
              <div className={styles.iconContainer}>
                {iconArray.map((item) => {
                  return (
                    <img src={item} alt="sportrex icons" className={styles.icon} />
                  )
                })}
              </div>
            </div>
